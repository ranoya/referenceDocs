...
<body>
  ...
  <p>Toda operação feita com <strong>pushMatrix()</strong> precisa ser aplicada com a função <a href="javascript:carrega('fun-popMatrix.php');"><strong>popMatrix()</strong></a>, ou seja, assim que o desenho com alterações em sua escala, angulação ou posicionamento é construído, ele só será efetivamente desenhado quando as operações na matriz forem finalizadas com <a href="javascript:carrega('fun-popMatrix.php');"><strong>popMatrix()</strong></a>.
