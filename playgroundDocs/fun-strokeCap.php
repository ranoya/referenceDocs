...
void draw() {
  ...
  <p><strong>strokeCap(<span class="marca">t</span>);</strong></p>
  ...
  <table>
    ...
    <tr>
      <td><span class="marca">t</span></td><td>const</td><td><span class="marca">SQUARE</span><br><span class="marca">ROUND</span></td><td>tipo de finalização</td>
    </tr>    
  </table>
