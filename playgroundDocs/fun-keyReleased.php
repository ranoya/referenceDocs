...
<body>
  ...
  <p>O evento de reconhecimento de uma tecla é dividido em 2 partes: um primeiro momento onde a tecla é pressionada, cujos procedimentos são definidos em <a href="javascript:carrega('fun-keyPressed.php');"><strong>keyPressed()</strong></a> e um segundo momento onde a tecla é liberada, cujos procedimentos são definidos em <strong>keyReleased()</strong>.
